...
/**
 * This class helps creating ipe-files in Java by providing functions for most common objects.
 * Currently supports: Mark, Rectangle, Path, Edge, Text label, Circle, Circular Arc, Spline,
 * Splinegon
 * <p>
 * Usage: The functions create an UML-String that corresponds to the specified object in Ipe. Every
 * file has to start with getIpePreamble(), followed by getIpeConf(), and has to end with
 * getIpeEnd().
 *
 * @author Martin Fink
...
public class IpeDraw {
   ...
   * @param shape shape: disk, fdisk, circle, box, square, fsquare, cross
   * @param color color
   * @param size  size: tiny, small, normal, large
   * @return
   */
   ...
   * @param y1    bottom-most y-coordinate
   * @param x2    right-most x-coordinate
   * @param y2    top-most y-coordinate
   * @param color color
   * @param pen   pen width: normal, heavier, fat, ultrafat
   * @param dash  dash style: normal, dashed, dotted, dash dotted, dash dot dotted
   * @return
   */
  ...
  /**
   * Draws an undashed path between points with pen width "normal" and color "black".
   *
   * @param x x-coordinates of the points
   * @param y y-coordinates of the points
   * @return
  ...
  /**
   * Draws an undashed edge between two points with pen width "normal" and color "black".
   *
   * @param x1 x-coordinate of point 1
   * @param y1 y-coordinate of point 1
   * @param x2 x-coordinate of point 2
  ...
  /**
   * Places a text label at a specific point with normal text-size and text-color "black".
   *
   * @param text The text
   * @param x    x-coordinate of the box
   * @param y    y-coordinate of the box
   ...
   * @param xStart  x-coordinate of the starting point on the circle
   * @param yStart  y-coordinate of the starting point on the circle
   * @param xEnd    x-coordinate of the end point on the circle
   * @param yEnd    y-coordinate of the end point on the circle
   * @param color   color
   * @param pen     pen width: normal, heavier, fat, ultrafat
   * @param dash    dash style: normal, dashed, dotted, dash dotted, dash dot dotted
   * @return
  ...
  /**
   * Draws an undashed circular arc in a mathematical positive sense with pen width "normal".
   *
   * @param xCenter x-coordinate of the center
   * @param yCenter y-coordinate of the center
   * @param xStart  x-coordinate of the starting point on the circle
  ...
  /**
   * Draws an undashed circular arc in a mathematical positive sense with pen width "normal" and
   * color "black".
   *
   * @param xCenter x-coordinate of the center
   * @param yCenter y-coordinate of the center
